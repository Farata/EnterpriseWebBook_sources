...
define(['order!login', 'order!donation', 'order!svg-pie-chart', 'modules/generic-module'], function() {
  return (function() {
    var auctionModule, initAuctionModule, initModule, lazyLoadingEventHandlerFactory, module, modulesConfig, way_to_give, what_we_do, where_we_work, who_we_are, _i, _len;
    ...
    initAuctionModule = function(aModuleConfig) {
      var handler;
      this.aModuleConfig = aModuleConfig;
      handler = function(event) {
        ...
        if (typeof module !== "undefined" && module !== null) {
          ...
          module = "loading";
          require(["modules/way-to-give"], function(WayToGive) {
